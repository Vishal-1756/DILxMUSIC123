...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"DILX/assets/anonx.png")
        ...
        font = ImageFont.truetype("DILX/assets/font2.ttf", 45)
        ImageFont.truetype("DILX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("DILX/assets/font2.ttf", 30)
        ImageFont.truetype("DILX/assets/font.ttf", 30)
